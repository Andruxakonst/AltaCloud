        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await _emailSender.SendEmailAsync(
                    ...
                    $"Для подтверждения аккаунта <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>нажмите здесь</a>.");

                StatusMessage = "Ссылка подтверждения для изменения отправленного письма. Пожалуйста, проверьте свою электронную почту.";
